...
def get_conversational_chain(model_name, vectorstore=None, api_key=None):
    if model_name == "OpenAI":
        ...
        prompt_template = """
        Answer the question as detailed as possible from the provided context with general knowledge\n
        Context:\n {context}?\n
        Question: \n{question}\n
...
def main():
    ...
    with st.sidebar:
        ...
        pdf_docs = st.file_uploader("Upload your PDF Files here and Click on the Submit & Process Button", accept_multiple_files=True)
